...
label cap1Honoka:
    ...
    "Soy Honoka Kousaka, tengo 16 años. Voy en segundo año de la preparatoria Otonokizaka" with dissolve id cap1Honoka_6cd8d7a5
    $ quick_menu = True
    "¡Y formo parte del superexitoso grupo de idols escolares μ's! Bueno, eso me gustaría decir, pero honestamente, ¿será que es cierto?"
    "Ah, ajajajaja, aah" 
    scene black with dissolve
    stop music fadeout 1.5
    "Agh, no debí haber pensado eso..." with dissolve
    "¡No puedes rendirte cuando apenas estás empezando!" 
    "De acuerdo" 
    "Bien, vamos otra vez, ¡con sentimiento!" 
    ...
    "Soy {color=#FFAE00}Honoka Kousaka{/color}, tengo 16 años" 
    "En abril decidí debutar como idol escolar junto a mis amigas. Aunque a decir verdad, creo que somos muy… normales como para llamarnos \"idols\"" 
    "Quiero decir, nos vemos normales, no somos buenas cantando, tampoco tenemos talento en la actuación, y si ves nuestras fotos..."  
    ...
    "Sí, y por eso nos convertiremos en las brillantes idols con las que todos sueñan, y vamos a esforzarnos mucho, llamaremos la atención de todos y salvaremos nuestra escuela" 
    "La {b}preparatoria Otonokizaka{/b} ¡Lo prometo!" 
    "En verdad, quisiera que todos nos dieran su apoyo. Porque..."  
    ...
    "Nuestra escuela, Otonokizaka, es una escuela pública que se encuentra en el vecindario donde nacimos"  
    "Pero aunque diga \"pública\", en realidad es una escuela \"nacional\", pero está lejos de todas las estaciones de tren, y quizás por eso todas las que asisten son chicas locales" 
    "Tampoco tiene algún club sobresaliente ni un nivel alto en educación, es completamente lo opuesto a la elegante y refinada imagen que te viene a la mente cuando escuchas \"escuela nacional\"" 
    ...
    "Dejando una región de la capital sin preparatoria, por eso deberían nombrar la escuela nacional en vez de cerrarla" 
    "Sí que es la descendiente de una larga generación de artistas marciales. Sabe de todas esas cosas complicadas, ¿no?"  
    hide UmiS with dissolve
    
    "Yo soy tonta, así que no sé nada de eso o cosas de adultos, pero sí sé que la preparatoria Otonokizaka es importante y siempre ha estado aquí" 
    "Es el corazón de nuestro vecindario."  
    "Barrio especial Chiyoda, Tokio. Akihabara, Kanda, Jinbocho y Ochanomizu. En medio de esos lugares, en donde gente de todo Japón se reúne, se encuentra nuestro vecindario, como si fuera un valle marrón rodeado de edificios"  
    scene atardecer with fade
    "De hecho, quizá no haya tanta tierra como para llamarlo valle marrón, ¿o sí?" with dissolve
    "Pero cuando era niña, no había tantos edificios como ahora. Era un vecindario tan tranquilo, con parques, espacios abiertos y bellos atardeceres"
    scene cielo with fade
    "Por supuesto, yo no sé si es verdad, pero mi abuela, que vive conmigo, dice que esta es una de las pocas ciudades que no desapareció con los bombardeos de la {a=https://acortar.link/zgejGa}{color=#E000FF}Guerra del Pacífico{/color}{/a}" with dissolve
    "Es cierto que cuando recorres las calles puedes ver viejos edificios y muchos negocios antiguos" 
    "Está el famoso puesto de soba. Y la tienda de dulces estilo occidental que le encanta a mi abuela, y que apareció en los libros de Shotaro Ikenami"  
    "El restauran occidental que le gustaba al gran autor que mencionan en los libros de texto, Souseki Natsume. Y el puesto que vende delicioso sushi"  
    "También está la venerable tienda de ramen dirigida por dos ancianitas. Y el spa, con mujeres en kimono entrando y saliendo todo el día" 
    "En este vecindario, puedes llegar a apreciar todo tipo de escenarios antiguos, escondidos entre los viejos edificios y las casas hechas de madera y tejas"  
    "Camina un poco y te toparás con un montón de trenes y autos, pero este vecindario está mayormente transitado por peatones" 
    "Así se siente" 
    "Cuando piensas en ello, es un lugar un tanto misterioso, ¿no? Pero aquí nací y aquí crecí. Este es el único lugar que conozco perfectamente"  
    "Jardín de niños, primaria, secundaria, todas eran escuelas públicas y por supuesto, las únicas clases particulares que tuve fueron clases de piano con una señora que vive cerca de aquí" 
    "Aunque no practicaba y luego luego lo dejé, jejeje ♡" 
    "Las clases de ábaco en el parque, oh, y las clases de caligrafía con el tío de Umi-chan" 
    "¡Ah, y mi clase favorita era la de natación que se daba en la piscina pública! Cuando terminaban las clases, buscábamos donde jugar balón prisionero o a perseguirnos." 
    "Subirse al tren era algo que ocurría pocas, muy pocas veces, como cuando le rogabas a tu mamá que fueran al cine durante las vacaciones de verano o primavera." 
    "Así que, aunque estemos en el barrio especial Chiyoda, no encajamos mucho aquí, ¿o sí? Vivimos en nuestro pequeño universo de 500 metros. Jeje" 
    "Por eso es que nunca noté que nuestro vecindario se volvía urbano." 
    "Y, aunque estamos en medio de la ciudad, el número de niños seguía reduciéndose y también estaba el problema de la población."
    
    stop music fadeout 1.3
    scene black 
    "Yo nunca supe de eso..." with dissolve
    ...
    "Aunque está en medio de la ciudad ¿tiene áreas grandes y muchos árboles? Ah, y como no hay muchas estudiantes, también hay mucho espacio. Eso sería todo, creo" 
    "Dado que he vivido todo el tiempo aquí, siempre pensé que cuando creciera, ¡usaría el uniforme de Otonoki y me volvería una estudiante de Otonoki!" 
    "¿Por qué? No es como que recordase haber tenido algún encuentro fantástico con una de las chicas de Otonoki, o ninguna otra clase de inspiración"  
    "Aún así, mis compañeras de clase tenían hermanas que fueron a Otonoki, las veía andar riendo y divirtiéndose juntas por el vecindario" 
    "Verlo era algo tan normal para mí, que simplemente quería ser como ellas"  
    "¿No les pasa eso a todos?"
    ...
    "Aún así, era un futuro emocionante, siempre frente a ti, pero nunca al alcance hasta que llegase el momento" 
    "Era la escuela a la que siempre, siempre quise asistir"  
    "Pensé que cuando creciera, sería como una de esas chicas. Ahora que lo pienso, ¿quizá también se debía a que había poca gente?"
    "Sin importar la época, las chicas vistiendo el uniforme de Otonokizaka siempre estaban tranquilas, no como esas chicas ricas que ves en la TV" 
    "Se veían tan alegres y amables, parecía que recibían algún tipo de trato especial de parte de la gente del vecindario. Quizás por eso, para mí, esas chicas eran como el símbolo representativo del vecindario"
    "Esas chicas, con sus bellos y bien arreglados uniformes azules eran mi modelo a seguir" 
    "Bueno, tal vez yo no me veo como una chica de esa edad jejeje" 
    "Por eso aún no puedo creerlo"  
    "La preparatoria a la que siempre quise ir, Otonokizaka, está a punto de cerrar" 
    ...
    "Cuando llegas a segundo, significa que ya sobreviviste el primer año en la nueva escuela y todavía no tienes que preocuparte por los exámenes de la universidad, así que es el mejor momento para divertirte, ¿no es así?"
    "Y el clima estaba perfecto aquella mañana, parecía que los Dioses festejaban conmigo, estaba tan emocionada de comenzar mi nueva vida en la preparatoria"  
    "Cuando me encontré con Kotori-chan y Umi-chan, las saludé con una gran sonrisa" 
    #show KousakaHonoka at top with dissolve
    voice "audio/VoiceHonoka/goodday.mp3"
    K_Honoka "¡Hoy es un gran día!" 
    "Y luego..."
    scene beginner with dissolve
    $ renpy.pause(1.5, hard = True)
    "Con un semblante nervioso, ambas me llevaron al tablón de anuncios, en donde se encontraba la noticia del cierre de la escuela"
    scene beginner2 with dissolve
    $ renpy.pause(0.5, hard = True)
    "¡Ooohh, vamos!" with hpunch 
    "Me duele el pecho sólo de recordarlo. Hay gente que dice \"Lo veo y no lo creo\" pero... esa vez, eso era lo que me pasaba. Era imposible, era mentira, tenía que ser eso" 
    "Todas las ideas y palabras se esfumaron de mi mente, en automático pellizqué mi mejilla. Quizás fue debido a la sorpresa, pero no sentía nada, apenas sentí dolor" 
    "Y por eso pensé \"¡Ah, ya sé! ¡Es sólo un sueño!\" Y mi cabeza comenzó a dar vueltas. No estaba segura de qué pasaba, pero luego, estaba sentada en mi pupitre" 
    ...
    M_Kotori "¿Estás bien, Honoka-chan?"
    "Cuando las vi, con esa preocupación. Por fin me di cuenta. Ah, no fue un sueño"
    # PENDIENTE voice "audio/VoiceHonoka/.mp3"
    K_Honoka "Cierre..." 
    "Eso quería decir que mi querida preparatoria Otonokizaka iba a desaparecer" 
    "Luego de un tiempo, no andaría ninguna estudiante en este edificio; y esas chicas con sus uniformes, que nunca imaginé que dejaría de ver en el vecindario, también desaparecerían" 
    "¡Ah! Y además, si cerraba, ¡¿qué pasaría con los dos años que me faltaban de preparatoria?! ¿Qué voy a hacer?" 
    "Reprobé materias el año pasado, y en verdad no creo ser capaz de aprobar otro examen de admisión en este punto" 
    "Mientras pensaba esto, Kotori-chan me miró con pena y una sonrisa débil" 
    voice "audio/VoiceKotori/002.mp3" 
    M_Kotori "La escuela va a cerrar hasta dentro de tres años, cuando se hayan graduado todas las estudiantes"
    "Ah, muy bien"
    stop music fadeout 1.3
    ...
    "Pero, al parecer, comencé a pensar en voz alta y me levanté de mi lugar" 
    scene aula with dissolve
    K_Honoka "¿TRES AÑOS?" with hpunch   
    "Recibir dos noticias así en un solo día drenó toda mi energía"
    ...
    "Parecía mucho pero poco, poco pero mucho. Tres años" 
    "El curso completo de preparatoria" 
    "Digo, es cierto que ya no estaremos en esta escuela en tres años"
    "Sin importar si trato de quedarme, es normal que me gradúe en tres años" 
    "Aunque no sé si voy a ir a la universidad o si empezaré a trabajar, ya no será mi problema para entonces, y ya no tendré derecho a oponerme al cierre" 
    "Pero aún así..."  
    scene aula with dissolve
    voice "audio/VoiceHonoka/004.mp3"
    K_Honoka "¿Estoy de acuerdo con esto?" with dissolve 
    "En tanto no me afecte, en tanto pueda graduarme, ¿entonces no hay problema?" 
    "..." 
    "..." 
    "..." 
    "En realidad no puedo pensar de esa forma" 
    "¿Por qué cerrará Otonoki?" 
    "Es imposible" 
    "Otonoki ha sido parte de nuestra vida por tanto tiempo, y ahora, ¿va a desaparecer del mapa?"  
    ...
    "Cuando les dije a Umi-chan y a Kotori-chan, que estaban frente a mí, se veían algo incómodas" 
    "La mamá de Kotori-chan es la directora de la escuela, así que quizás tenga problemas por hablar así. Pero, está mal"  
    "No pueden cerrar la escuela porque sí, sin preguntarle a las estudiantes" 
    "Ya sé que de la escuela se encargan los adultos, ¡pero aún así! Esta escuela, Otonokizaka, le pertenece a sus estudiantes, ¿o no?"
    "Si cierra, bueno, ¡no podemos quedarnos aquí sin hacer nada! Si hubiéramos sabido que nuestra escuela cerraría, tal vez pudimos haber hecho algo..."  
    "Quiero decir, sólo pusieron el letrero \"Anuncio de cierre\" en el tablón junto al anuncio en el que reclutan voluntarios para la biblioteca, como si no fuera la gran cosa" 
    "¿No es ridículo?" 
    "Si hay más chicas tan distraídas como yo, que nunca ven el tablón de anuncios, estarían en grandes problemas ¡ya que la escuela cerraría de repente!" 
    "¡En serio, qué ridiculez!" 
    scene aula with dissolve
    "¡Mm, estoy llenándome de energía otra vez!" with dissolve 
    "Debe haber algo que pueda hacer" 
    "Por mi escuela" 
    "Y por eso yo, Honoka, {b}nunca me voy a rendir{/b}" 
    "Esto es lo que creo" 
    scene otonoki with dissolve
    ...
    "Entonces nunca debes rendirte" 
    "Sin importar qué, no te rindas, nunca, sigue intentando y sólo así tus sueños se harán realidad" 
    "No importa si es algo pequeño" 
    "Siempre que sigas adelante, aunque sea poco a poco, es lo único que necesitas" 
    "Porque cuando alguien escala una gran montaña, que ocupa toda su visión y alcanza las nubes, van paso a paso" 
    "Enfocarme en lo que está frente a mí y dirigirme al objetivo es lo único que sé hacer"
    "Aunque eso no significa que nunca tenga miedo, a veces, eso pienso..." 
    scene determinacion with dissolve
    "No puedo detenerme" with dissolve 
    "Si lo hago, ya no podré seguir adelante"
    "En momentos como ese, en los más difíciles, en los más dolorosos, son en los que debo apretar la mandíbula y seguir adelante, aunque sea un milímetro" 
    "No voy a perder si siempre sigo avanzando"
    "Así es como pienso siempre"   
    "Pero, si me rindo, entonces ahí termina todo" 
    "La vida es muy simple" 
    "Cuando digo cosas como esas la gente se ríe de mí y me dice que sueno como una porrista" 
    "Pero no me voy a unir a ningún club deportivo, ¿entendido?"
    "No, porque... voy a comenzar el club de idols..."  
    "No, ¡un club de idols escolares!" 
    "Cantaré, bailaré, seré linda y brillaré, y llamaré la atención de todos, y entonces, ¡el número de estudiantes en la preparatoria Otonokizaka aumentará!" 
    "Un día, cuando en verdad me vuelva una idol famosa, espero que pueda expresar estos sentimientos al público"  
    ...
    "Y con ese deseo, me iré a dormir esta noche" 
    "¡Mañana practicaremos duro!"
    $ quick_menu = False 
    scene black with fade
